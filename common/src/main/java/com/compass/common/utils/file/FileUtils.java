...
public class FileUtils
{
    ...
    {
        return writeBytes(data, CompassConfig.getImportPath());
    }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/compass.png -- compass.png
     * 
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/compass.png
     * 
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
