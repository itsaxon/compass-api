...
import com.compass.common.utils.file.MimeTypeUtils;
import com.compass.biz.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(CompassConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
